...
class Document(Base):
    ...
    person_id = Column(String(36), ForeignKey("persons.id", ondelete="CASCADE"), nullable=True)
    ...
    issue_date = Column(String(10), nullable=True) # Format: YYYY-MM-DD
    expiry_date = Column(String(10), nullable=True) # Format: YYYY-MM-DD
