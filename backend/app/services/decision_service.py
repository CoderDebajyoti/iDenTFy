...
def evaluate_document_decision(
    ...
    # 5. Synthesis Rules
    if match_type in ("skipped", "bypassed") and mrz_valid and not tampering_result.get("requires_review"):
        reasons.append("Document passes optical and forensic screening (Database matching bypassed).")
